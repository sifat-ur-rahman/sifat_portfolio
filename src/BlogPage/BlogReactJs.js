...
const BlogReactJs = (props) => {
    return (
        <div className='lg:w-[1000px] lg:mx-auto mx-6 my-16'>
            ...
            <p className='text-2xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-violet-600'>Advantages of using React JS</p>
            <p className='text-xl text-justify mb-3'>There are several benefits of using React JS to build web applications, including:</p>
            <p className='text-xl text-justify mb-3'>👉 React follows a component-based architecture, which means that UI elements can be broken down into smaller, reusable components. This helps in reducing development time and effort, as well as improving the maintainability of the code.</p>
            <p className='text-xl text-justify mb-3'>👉 React uses a virtual representation of the DOM, which allows for efficient updates and rendering of changes. It calculates the minimum changes required to update the actual DOM, which makes React highly performant.</p>
            <p className='text-xl text-justify mb-3'>👉 React allows developers to use JSX, a syntax extension that allows them to write HTML-like code within their JavaScript code. This makes it easier to create and manage UI components.</p>
            <p className='text-xl text-justify mb-3'>👉 React has a large and active community of developers, which means that there are plenty of resources available for learning, support, and development.</p>
