      ...
      <div className="hero bgColor  lg:px-14">
        <div className="hero-content  flex-col lg:flex-row-reverse p-0">
          ...
          <div className=" p-4"  data-aos="fade-down">
            ...
            <p className="mb-4 font-sans lg:text-xl">I'm a developer specializing in React JS The main focus is front-end, <br />
             but at the same time, I try to new technology also, Currently. <br />
          ...
          download="https://drive.google.com/file/d/18BwhoPPsf8OWI8GNHyybAJYvyevXQtsE/view?usp=drive_link"
            href="https://drive.google.com/file/d/18BwhoPPsf8OWI8GNHyybAJYvyevXQtsE/view?usp=drive_link">
              <button className=" btn btn-outline bgColor px-8 text-xl rounded-full">Resume</button>
            </a>
          </div>
        </div>
      </div>
